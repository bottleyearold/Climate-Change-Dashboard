    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavItem(dbc.NavLink("Temperature Change", href="https://finaldashboard-7.onrender.com", style= {"padding-left": "35px", "padding-right": "35px"})),
